...
func Students(students []*types.Student) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"col-md-9 ms-sm-auto col-lg-10 px-md-4\"><div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom\"><h1 class=\"h2\">Estudiantes</h1></div><form hx-post=\"/students\" hx-swap=\"afterbegin\" hx-target=\"#students-list\" hx-ext=\"json-enc\" class=\"row g-3\"><div class=\"col-md-2\"><label for=\"inputNombre\" class=\"form-label\">Nombre</label> <input type=\"text\" name=\"name\" class=\"form-control input-small\" id=\"inputNombre\" placeholder=\"Nombre\" required></div><div class=\"col-md-2\"><label for=\"inputApoderado\" class=\"form-label\">Apoderado</label> <input type=\"text\" name=\"representative\" class=\"form-control input-small\" id=\"inputApoderado\" placeholder=\"Apoderado\" required></div><div class=\"col-md-2\"><label for=\"inputRut\" class=\"form-label\">RUT</label> <input type=\"text\" name=\"rut\" class=\"form-control input-small\" id=\"inputRut\" placeholder=\"RUT\" required></div><div class=\"col-md-2\"><label for=\"inputTelefono\" class=\"form-label\">Teléfono</label> <input type=\"text\" name=\"phone\" class=\"form-control input-small\" id=\"inputTelefono\" placeholder=\"Teléfono\" required></div><div class=\"col-md-2\"><label for=\"inputEmail\" class=\"form-label\">Email</label> <input type=\"email\" name=\"email\" class=\"form-control input-small\" id=\"inputEmail\" placeholder=\"Email\" required></div><div class=\"col-12\"><button type=\"submit\" class=\"btn btn-primary\">Crear Estudiante</button></div></form><br><div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom\"><h1 class=\"h2\">Buscar</h1></div><form class=\"row g-3\" hx-get=\"/students/search\" hx-swap=\"outerHTML\" hx-target=\"#students-list\"><div class=\"col-md-3\"><input type=\"text\" class=\"form-control input-small\" id=\"inputSearch\" name=\"search_name\" placeholder=\"Nombre\"></div><div class=\"col-md-3\"><button type=\"submit\" class=\"btn btn-primary\">Buscar</button></div></form><br>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = StudentsTable(students).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
